...
import com.skyowl.common.event.UserCreatedEvent;
...
public class UserService {
    ...
    public UserService(JdbcTemplate jdbc, EventPublisher eventPublisher, MeterRegistry registry) {
        ...
        this.createCounter = Counter.builder("skyowl_user_create_total")
                .tag("service", SERVICE_NAME).register(registry);
        this.createFailCounter = Counter.builder("skyowl_user_create_failed_total")
                .tag("service", SERVICE_NAME).register(registry);
        this.publishCounter = Counter.builder("skyowl_user_publish_total")
                .tag("service", SERVICE_NAME).register(registry);
        this.userOpTimer = Timer.builder("skyowl_user_op_duration")
                .tag("service", SERVICE_NAME).register(registry);
    }
