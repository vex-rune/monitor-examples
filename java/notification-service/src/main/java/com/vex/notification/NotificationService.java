...
public class NotificationService {
    ...
    public NotificationService(JdbcTemplate jdbc, MeterRegistry registry) {
        this.jdbc = jdbc;
        this.receivedCounter = Counter.builder("vex_notification_received_total")
                .tag("service", SERVICE_NAME).register(registry);
        this.sentCounter = Counter.builder("vex_notification_sent_total")
                .tag("service", SERVICE_NAME).register(registry);
        this.failCounter = Counter.builder("vex_notification_failed_total")
                .tag("service", SERVICE_NAME).register(registry);
    }
    ...
    private void handleUserCreated(UserCreatedEvent e) {
        ...
        saveNotification(e.getUserId(), null, "USER_WELCOME",
            "欢迎加入", "Hi " + e.getUsername() + ", 欢迎使用 vex 服务！");
    }
